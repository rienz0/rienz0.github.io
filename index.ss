  ...
  (preset
    ...
    `(body ()
      ...
      (ul ()
        ...
        (li () (a ((href "./artworks.html")) "Artworks who have my regard.")))
      (h2 () "Papers of Mine")
      (ul ()
      ...
      (i () "Nothing for now.")
      (br ()) (br ())
      (pre () "Mail: rienzzo at proton dot me
Telegram: @r1enzo
The source of this website can be found " (a ((href "https://github.com/rienz0")) "here") ".")
      (pre () "GAT/CS/L/M/MU/P d+ s: a--- C++ UL++ L+++ W++ PS-- Y++ !t R--- !tv b+++ e h* !r !y"))))
